                        ...
                        <li>
                           ...
                           if ( $rol==1 ){ ?>
                              ...
                              <li>
                                 ...
                                 <ul class="sub-menu">
                                    <li><a href="index.php?view=User/ViewUser">Ver ADMIN</a></li>
                                    <li><a href="index.php?view=User/AddUser">Ingresar ADMIN</a></li>
                                 </ul>
                              </li>
                              
                              <li>
                                 <a href="#"><i data-feather="link"></i>
                                    <span>Api</span><i class="accordion-icon fa fa-angle-left"></i></a>
                                 <ul class="sub-menu">
                                    <li><a href="index.php?view=Api/AddApi">Añadir Api SU</a></li>
                                    <li><a href="index.php?view=Api/ViewApi">Ver Api SU</a></li>
                                 </ul>
                              </li>
                           ...
                           <li>
                              ...
                              <ul class="sub-menu">
                                 <li><a href="index.php?view=Vehiculo/AddVehiculo">Añadir vehiculo ADMIN</a></li>
                                 <li><a href="index.php?view=Vehiculo/ViewVehiculo">Ver vehiculo ADMIN</a></li>
                              </ul>
                           </li>
