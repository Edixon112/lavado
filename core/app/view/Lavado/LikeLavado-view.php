				...
				<form class="form-horizontal" method="post" id="addproduct" action="index.php?action=Lavado/EditLavado" role="form">
					...
					<input type="text" style="display: none" name="id" id="id" value="<?php echo $Lavado->id;?>" readonly="true"  required />
                        ...
                        <div class="col-md-4 mb-3">
                            <?php $cliente=ClienteData::getById($Lavado->idcliente);
                            $dato=$cliente->nombre;
                            ?>
                        ...
                        <!-- col -->
                        <div class="col-md-4 mb-3">
                            <?php $vehiculo=VehiculoData::getById($Lavado->idvehiculo);
                            $placa=$vehiculo->placa;
                            ?>
                            <label for="validationCustom01">VEHICULO</label>
                            <input disabled="" type="text" class="form-control" id="placa" value="<?php echo $placa;?>" name="placa" required>
                            <div class="valid-feedback">
                            aqui
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <?php 
                            $fechadeentrada=$Lavado->fechadeentrada;
                            ?>
                            <label for="validationCustom01">FECHA</label>
                            <input disabled="" type="text" class="form-control" id="fechadeentrada" value="<?php echo $fechadeentrada;?>" name="fechadeentrada" required>
                            <div class="valid-feedback">
                            aqui
                            </div>
                        </div>
